...
column1 = dbc.Col(
    [
        ...
        dcc.Markdown(
            ...
            *I first tried using a time-based split; however, since the time period with the worst potholes was so drastically different, I was unable to successfully get a positive R^2 value when applying a model to the test data from later in the year, and I decided to use a random split instead. 
